...
const ICONE_MERGULHADOR = "/images/icone-mergulhador.svg";

const Newsletter = () => {
  return (
    <div className="bg-azul-claro font-inter min-h-screen flex justify-center items-center">
      <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
        ...
        <section className="bg-white p-10 flex gap-6 flex-col rounded-lg lg:w-1/2 lg:rounded-l-none justify-center">
          ...
          <form>
            ...
            <input
              className="text-sm w-full mb-4 pl-3 py-2 rounded border shadow focus:outline-none hover:border-azul-claro hover:ring-1 hover:ring-azul-escuro focus:border-azul-escuro focus:ring-1 focus:ring-azul-escuro"
              id="email"
              type="email"
              placeholder="Digite seu endereço de email"
            />
            <button
              className="font-bold text-white bg-azul-escuro w-full py-2 rounded-full shadow-2xl hover:bg-azul-hover duration-300"
              type="button"
            >
              Inscreva-se
            </button>
